...
export function Update(): JSX.Element {
    ...
    function onChange(ev: React.ChangeEvent<HTMLInputElement>) {
        ...
        console.log();
        const newDate = { ...data, [name]: value };

        setData(newDate);
    }

    function onUpdate(ev: FormEvent) {
        ev.preventDefault();
        api.put(`/patient`, data)
            .then(() => {
                alert('Patient Updated with sucess');
            })
            .catch(function (error) {
                console.error(error);
            });
        history.push(`/patients/details/${id}`);
    }
            ...
            <div className={styles.box}>
                <form onSubmit={onUpdate}>
                    ...
                    <div className={styles.button}>
                        <Button type={'submit'} text={'Update'} isUpdate />
                    </div>
                </form>
            </div>
        </div>
